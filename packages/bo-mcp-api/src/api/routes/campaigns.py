...
def _coerce_intake(intake: IntakeData) -> CampaignIntakeInput:
    ...
    try:
        return CampaignIntakeInput(
            ...
            acquisition_beta=intake.acquisition_beta,
            scalarization=intake.scalarization,
            scalarizer=intake.scalarizer,
...
async def get_campaign_config(
    ...
    return CampaignConfigResponse(
        ...
        scalarization=str(spec.scalarization),
        scalarizer=str(spec.scalarizer) if spec.scalarizer is not None else None,
